    ...
    return(
        <footer>
            ...
            <Container className="footerMiddle pb-5">
                <Row>
                    <Col md={7}>
                        <p><span className="text-grey">Du er klar over og forstår at du gir informasjon til meistersocial. Den eneste bruken av denne informasjonen vil være å administrere denne kampanjen.</span>
...
vennligst se Konkurransepolitikken. Opphavsrett © 2025 meistersocial.
