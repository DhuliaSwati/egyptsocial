          ...
          <Row className="justify-content-center">
            <Col md={10} lg={8}>
              <div className="terms-content mt-4 mb-5 p-4">
                ...
                <p><strong>Jackpot Limited</strong> (vi, oss, vår) som driver som <strong>Social Casino</strong> opererer det sosiale tilbudet som er tilgjengelig via <a href="http://www.socialcasino.com" target="_blank" rel="noreferrer">www.socialcasino.com</a> og alle underdomener, inkludert spillene, innholdet, funksjonene, verktøyene og tjenestene som tilbys der og på våre tilknyttede sosiale mediesider.</p>
                ...
                <p>Denne personvernerklæringen beskriver hvilke typer personopplysninger vi samler inn om brukere av vår plattform (Brukere, du, din), hvordan vi bruker dem, hvem vi deler dem med, hvordan vi holder dem trygge, og hvordan du kan kontrollere dem. Vennligst gjennomgå denne personvernerklæringen nøye og send oss en e-post til <a href="mailto:dataprivacy@socialcasino.com">dataprivacy@socialcasino.com</a> hvis du har spørsmål.</p>

                <p>Denne personvernerklæringen bør leses sammen med, og danner en del av, <strong>Social Casino Terms of Service</strong>. Ethvert stortavledd begrep i denne personvernerklæringen som ikke er definert her har den betydningen som er gitt i våre vilkår.</p>
                ...
                <p>I henhold til loven kan du ha visse rettigheter angående personopplysningene vi samler inn og lagrer. Hvis du ønsker å utøve noen av disse rettighetene, vennligst kontakt oss på <a href="mailto:dataprivacy@socialcasino.com">dataprivacy@socialcasino.com</a>.</p>
                ...
                <p>Hvis du har spørsmål om dine personopplysninger, hvordan vi samler inn eller bruker dem, eller du ønsker å utøve dine rettigheter med hensyn til personopplysninger, vennligst kontakt vår personvernansvarlig via e-post på <a href="mailto:dataprivacy@socialcasino.com">dataprivacy@socialcasino.com</a>.</p>
              </div>
            </Col>
          </Row>
        </Container>
